...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/omniauth/openid/version.rb", mod) }::OmniAuth::OpenID::Version::VERSION
  else
...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["Alex Kirmse", "James A. Rosen", "Michael Bleigh", "Boy van Amstel", "Erik Michaels-Ober", "Marc Beyerlin", "SixArm", "DianthuDia", "Bryan Talbot", "tmilewski", "Bobby McDonald", "Jordan Owens", "Joel Parker Henderson", "Annibelle Boling", "Peter H. Boling"]
  spec.email = ["floss@galtzo.com"]

  spec.summary = "🫵 OpenID strategy for OmniAuth."
  spec.description = "🫵 OpenID (not OIDC) strategy for OmniAuth."
  spec.homepage = "https://github.com/pboling/omniauth-openid"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "https://omniauth-openid.galtzo.com"
  ...
  # The 'git' gem is optional; omniauth-openid falls back to shelling out to `git` if it is not present.
